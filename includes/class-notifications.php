...
class Notifications {
    ...
    private function init_hooks(): void {
        add_action( self::WEEKLY_HOOK, [ $this, 'send_weekly_digest' ] );
        add_action( self::MONTHLY_HOOK, [ $this, 'send_monthly_digest' ] );

        // Reschedule digests when frequency changes
        add_action( 'update_option_dcd_email_frequency', [ $this, 'reschedule_digests' ], 10, 2 );
    }
                            ...
                            <div class="post-item">
                                ...
                                <div class="post-meta">
                                    ...
                                    printf(
                                        ...
                                        $post['pageviews_current'],
                                        $post['pageviews_previous']
                                    );
                                    ?>
                                    &middot;
