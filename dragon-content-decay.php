...
define( 'DCD_PLUGIN_BASENAME', plugin_basename( __FILE__ ) );
...
// Load plugin classes
require_once DCD_PLUGIN_DIR . 'includes/class-plugin.php';
require_once DCD_PLUGIN_DIR . 'includes/class-admin.php';
require_once DCD_PLUGIN_DIR . 'includes/class-oauth.php';
require_once DCD_PLUGIN_DIR . 'includes/class-api-ga4.php';
require_once DCD_PLUGIN_DIR . 'includes/class-analyzer.php';
require_once DCD_PLUGIN_DIR . 'includes/class-scheduler.php';
require_once DCD_PLUGIN_DIR . 'includes/class-notifications.php';
